...
Laravel: config('app.name') helpers plus service providers' boot() methods; AI often hardcodes env reads (os.environ / env()) inline in views, or puts import-time side effects in models.py.
