...
Laravel: morphTo/morphMany polymorphic relations declared eagerly on models. Rails: polymorphic: true associations. AI reaches for polymorphic relations as the default for any flexible association.
