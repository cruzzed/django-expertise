...
Typical MVC controllers paginate inline in the controller method and pass the collection to the template, with all query logic inline in the controller.
