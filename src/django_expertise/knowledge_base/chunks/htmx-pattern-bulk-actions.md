...
AI manages a selected-ids array in React state, disables the Apply button until non-empty, and POSTs {ids: [...], action: '...'} JSON to an API - reimplementing what HTML forms already serialize for free.
