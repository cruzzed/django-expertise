...
Typical MVC stacks sprinkle date-library 'time ago' helpers in templates, or custom helper functions. AI writes custom template filters or JS date libraries for '3 days ago' formatting that humanize already provides.
