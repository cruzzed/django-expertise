...
AI builds a React modal portal with a global keydown listener in useEffect, focus trapping via refs, and a fetch-driven results list - or installs a kbar/cmdk dependency.
