...
Returning JsonResponse({...}) and writing client JS to template the result - because AI assumes all dynamic endpoints are REST/JSON APIs (DRF serializers, typical MVC API resource controllers).
