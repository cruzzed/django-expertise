...
AI uses a legacy accordion plugin or a CSS-framework collapse script, and for counters a keyup handler that imperatively updates the counter element's text plus manual class toggling in a script block.
