...
Building a SPA admin panel or hand-rolled CRUD controllers (typical MVC stacks: third-party admin packages or custom controllers) because 'the admin looks bad' - weeks of work duplicating built-in CRUD.
