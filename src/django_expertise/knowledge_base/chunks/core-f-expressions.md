...
Typical MVC defaults: raw SQL fragments for counter updates, or a read-modify-write in application code (increment attribute, then save). AI usually generates an application-side read-modify-write, which races under concurrency.
