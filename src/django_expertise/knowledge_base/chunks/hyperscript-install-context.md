...
AI defaults to a bundled npm dependency + a framework (Alpine.js x-data, Stimulus controllers, or a full SPA framework) and passes server data through data-* attributes or JSON <script> islands parsed in JS.
