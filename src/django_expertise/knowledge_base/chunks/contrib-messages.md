...
Laravel: session()->flash('success', ...) plus Blade alert partials; Rails: flash[:notice]. For API-first AI, returning {message: '...'} JSON for a React toast system instead of server-rendered feedback.
