...
Storing cart items / user role / draft state in data-* attributes, hidden inputs, or hx-vals JSON blobs posted back and forth - the React habit of client-side stores translated into HTML.
