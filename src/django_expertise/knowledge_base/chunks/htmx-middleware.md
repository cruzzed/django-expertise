...
Typical MVC controllers check the HX-Request header inline in every action, or via a helper macro in a before-filter. AI scatters header sniffing through views instead of centralizing it.
