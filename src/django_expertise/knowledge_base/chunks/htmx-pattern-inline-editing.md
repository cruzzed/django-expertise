...
AI builds an inline-editable React table row with controlled inputs, local state, and a PATCH JSON call - or a Laravel Livewire component. Heavy client state machinery for what is two partial templates.
