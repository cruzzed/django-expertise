...
Typical MVC query builders use nested where closures with chained OR calls, or raw SQL string fragments. AI often emits raw SQL WHERE strings or chained OR calls that mishandle operator precedence.
