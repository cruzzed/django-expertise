...
Laravel: session([...]) helper or - for SPA-minded AI - client-side state in localStorage / a JS store / JSON hidden inputs. React-trained AI keeps cart state in the browser and posts it back.
