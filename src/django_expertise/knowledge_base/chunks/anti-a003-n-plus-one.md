...
Template-driven lazy loading: {{ product.category.name }} triggering a query per row (the same relation traversal happens in typical MVC templates), because AI examples rarely show eager loading.
